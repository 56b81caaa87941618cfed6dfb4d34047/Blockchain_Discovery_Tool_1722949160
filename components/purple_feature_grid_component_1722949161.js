    ...
    <div id="features-grid" class="grid md:grid-cols-3 gap-8 md:gap-12 bg-white p-5">
        ...
        <div id="feature-1">
            <div id="feature-1-header" class="flex items-center space-x-2 mb-1">
                ...
                <div class="flex" id="feature-1-title-container"><h4 id="feature-1-title" class="flex-1 text-slate-50 font-medium">Real-Time Data Feeds</h4></div>
            </div>
            <div class="flex" id="feature-1-description-container"><p id="feature-1-description" class="flex-1 text-sm">Stay up-to-date with the latest blockchain activity. Our app provides real-time data feeds, ensuring you never miss a beat in the dynamic world of decentralized networks.</p></div>
        </div>
        <!-- Feature -->
        <div id="feature-2">
            <div id="feature-2-header" class="flex items-center space-x-2 mb-1">
                ...
                <div class="flex" id="feature-2-title-container"><h4 id="feature-2-title" class="flex-1 text-slate-50 font-medium">Comprehensive Data Explorer</h4></div>
            </div>
            <div class="flex" id="feature-2-description-container"><p id="feature-2-description" class="flex-1 text-sm">Dive deep into blockchain data with our powerful explorer. Analyze transactions, track wallet activities, and gain insights into network statistics effortlessly.</p></div>
        </div>
        <!-- Feature -->
        <div id="feature-3">
            <div id="feature-3-header" class="flex items-center space-x-2 mb-1">
                ...
                <div class="flex" id="feature-3-title-container"><h4 id="feature-3-title" class="flex-1 text-slate-50 font-medium">Custom Notifications</h4></div>
            </div>
            <div class="flex" id="feature-3-description-container"><p id="feature-3-description" class="flex-1 text-sm">Set up custom notifications to stay informed about specific events or activities on the blockchain that matter most to you. Never miss an important update.</p></div>
        </div>
        <!-- Feature -->
        <div id="feature-4">
            <div id="feature-4-header" class="flex items-center space-x-2 mb-1">
                ...
                <div class="flex" id="feature-4-title-container"><h4 id="feature-4-title" class="flex-1 text-slate-50 font-medium">Secure and Decentralized</h4></div>
            </div>
            <div class="flex" id="feature-4-description-container"><p id="feature-4-description" class="flex-1 text-sm">Our app leverages the inherent security and transparency of blockchain technology, ensuring your data remains safe, immutable, and decentralized.</p></div>
        </div>
        <!-- Feature -->
        <div id="feature-5">
            ...
            <div class="flex" id="feature-5-description-container"><p id="feature-5-description" class="flex-1 text-sm">Don't be limited to a single blockchain network. Our app supports multiple leading blockchain platforms, allowing you to explore and interact with diverse ecosystems.</p></div>
        </div>
        <!-- Feature -->
        <div id="feature-6">
            ...
            <div class="flex" id="feature-6-description-container"><p id="feature-6-description" class="flex-1 text-sm">Integrate blockchain data seamlessly into your applications with our developer-friendly APIs. Build innovative solutions on top of our robust infrastructure.</p></div>
        </div>
    </div>`,
        data() {
            return {
