...
Vue.component("purple_hero_component_1722949161", {
    template: `
    <section id="hero-section-container" class="bg-gradient-to-br from-pink-500 via-purple-600 to-black">
        ...
        <div id="hero-content-container" class="pt-32 pb-16 md:pt-52 md:pb-32">
            ...
            <div id="hero-content" class="max-w-3xl mx-auto text-center bg-white bg-opacity-20 backdrop-filter backdrop-blur-lg rounded-lg shadow-lg p-8" style="position: relative; z-index: 1">
                <div id="announcement-text" class="mb-6" data-aos="fade-down">
                    <div id="announcement-text-inner" class="flex relative">
                        <a id="announcement-link" class="flex-1 btn-sm py-0.5 transition duration-150 ease-in-out group relative rounded-full shadow text-pink-100 hover:text-white" 
                           href="#0" 
                           style="background: linear-gradient(rgba(236, 72, 153, 0.3), rgba(168, 85, 247, 0.3)) padding-box, linear-gradient(rgba(236, 72, 153, 0.5), rgba(168, 85, 247, 0.5)) border-box;">
                            <span id="announcement-link-text" class="relative inline-flex items-center">
                                Discover the latest blockchain projects and technologies 
                ...
                <div class="flex" id="hero-text-container">
                    <h1 id="hero-text" class="h1 bg-clip-text text-transparent bg-gradient-to-r from-pink-300 via-purple-300 to-pink-300 pb-4" data-aos="fade-down">Explore the Decentralized Future</h1>
                </div>
                <div class="flex" id="sub-hero-text-container">
                    <p id="sub-hero-text" class="flex-1 text-lg mb-8 text-pink-100" data-aos="fade-down" data-aos-delay="200">Stay ahead of the curve with our comprehensive blockchain research and analysis platform.</p>
                </div>
                <div id="buttons-container" class="flex justify-center space-x-4 mt-8">
                    <div id="get-started-button-container">
                        <a id="get-started-button" 
                           class="flex items-center justify-center px-6 py-3 text-white bg-pink-600 bg-opacity-70 rounded-lg shadow-md transition duration-150 ease-in-out hover:bg-opacity-90 focus:outline-none focus:ring-2 focus:ring-pink-500 focus:ring-opacity-50" 
                           href="#0">
                            Get Started 
                    ...
                    <div id="docs-button-container">
                        <a id="docs-button" class="flex items-center justify-center px-6 py-3 text-pink-100 bg-white bg-opacity-20 rounded-lg shadow-md transition duration-150 ease-in-out hover:bg-opacity-30 focus:outline-none focus:ring-2 focus:ring-pink-300 focus:ring-opacity-50" href="#0">
